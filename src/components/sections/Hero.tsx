        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left pt-20 lg:pt-0">
            ...
            <div className="inline-flex items-center space-x-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <span>Welcome to the future of web development</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
              Modern web development solutions for ambitious businesses. 
              From concept to deployment, we build fast, beautiful, and scalable applications.
            </p>
